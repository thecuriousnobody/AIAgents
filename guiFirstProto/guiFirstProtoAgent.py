...
class GUIApp(tk.Tk):
    ...
    def add_agent(self):
        ...
        create_button = ttk.Button(button_frame, text="Create", command=lambda: self.create_agent(agent_entry.get(), role_entry.get(), agent_dialog))
    ...
    def create_agent(self, agent_name, role, dialog):
        ...
        self.agents_treeview.insert("", "end", text=agent_name, values=(agent.role,))  # Insert name and role separately
